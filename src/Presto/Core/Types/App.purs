...
type AppEffects eff = (avar :: AVAR, frp :: FRP, dom :: DOM, ref :: REF, ui :: UI, storage :: STORAGE, ls :: LOCAL_STORAGE, exception :: EXCEPTION, network :: NETWORK, console :: CONSOLE, err :: EXCEPTION, ws :: WEBSOCKET | eff)
